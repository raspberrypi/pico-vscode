                      ...
                      ? `<div id="project-name-grid" class="grid gap-6 ${
                        ...
                        <div>
                          ...
                          <div class="flex">
                            ...
                            <button id="btn-create-from-example" class="focus:outline-none bg-transparent ring-2 focus:ring-4 ring-blue-400 dark:ring-blue-700 font-medium rounded-lg px-4 py-2 ml-4 hover:bg-blue-500 dark:hover:bg-blue-700 focus:ring-blue-600 dark:focus:ring-blue-800" tooltip="Create from example">Example</button>
                          </div>
