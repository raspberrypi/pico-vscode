...
import type { SupportedToolchainVersion } from "./toolchainUtil";
import { cloneRepository, initSubmodules, getGit } from "./gitUtil";
import { checkForGit } from "./requirementsUtil";
import { HOME_VAR, SettingsKey } from "../settings";
import Settings from "../settings";
import type { VersionBundle } from "./versionBundles";
import MacOSPythonPkgExtractor from "./macOSUtils";
...
import { unxzFile, unzipFile } from "./downloadHelpers";
import type { Writable } from "stream";
import { unknownErrorToString } from "./errorHelper";
import got from "got";
...
export function getScriptsRoot(): string {
  console.log(
    "scripts root:",
    joinPosix(__dirname.replaceAll("\\", "/"), "..", "scripts")
  );

  return joinPosix(__dirname.replaceAll("\\", "/"), "..", "scripts");
}
