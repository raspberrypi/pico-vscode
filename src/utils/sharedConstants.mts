...
export const WINDOWS_X86_GPERF_DOWNLOAD_URL =
  "https://github.com/oss-winget/oss-winget-storage/tree/" +
...
export const WINDOWS_X86_7ZIP_DOWNLOAD_URL =
  "https://7-zip.org/a/7z2501-x64.msi";
export const CURRENT_7ZIP_VERSION = "25.01";
